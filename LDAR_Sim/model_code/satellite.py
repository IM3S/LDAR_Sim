...
class satellite:
    def __init__(self, state, parameters, config, timeseries, deployment_days, id):
        ...
        # load pre-defined orbit grids, this is unique for each satellite, a function should
        # be created to automatically calculate grid based on the TLE_file/ the name of satellites
